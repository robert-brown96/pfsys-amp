...
@InputType()
class TransactionScheduleUpdateInput {
  @ApiProperty({
    required: false,
  })
  @IsJSON()
  ...
  @ApiProperty({
    required: false,
    type: () => ScheduleEntryUpdateManyWithoutTransactionSchedulesInput,
  })
  @ValidateNested()
  @Type(() => ScheduleEntryUpdateManyWithoutTransactionSchedulesInput)
  @IsOptional()
  @Field(() => ScheduleEntryUpdateManyWithoutTransactionSchedulesInput, {
    nullable: true,
  })
...
export { TransactionScheduleUpdateInput };
