...
@ArgsType()
class UpdateTransactionLineArgs {
  @Field(() => TransactionLineWhereUniqueInput, { nullable: false })
  where!: TransactionLineWhereUniqueInput;
  @Field(() => TransactionLineUpdateInput, { nullable: false })
  data!: TransactionLineUpdateInput;
}

export { UpdateTransactionLineArgs };
